...
if (isset($_SESSION['no_user_found'])) {
  ...
  include '../components/methods/getAPI.php'; // here we include of sign in method

  // Classes
include '../models/backend/userModel.php'; // here we include our new user model
